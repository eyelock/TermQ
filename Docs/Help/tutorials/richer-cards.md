...
**Requires:** [Tutorial 1](first-board.md) completed, or a board with a few terminals on it.
...
| **Backend** | Direct (default) or tmux — see [Tutorial 5](persistent-sessions.md) |
...
[Tutorial 3: Find Anything Fast](find-anything-fast.md) — Zoom mode, search, and the command palette.
