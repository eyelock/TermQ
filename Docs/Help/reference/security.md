...
See [Queued Actions](../tutorials/queued-actions.md) for the full model.
...
**Secrets** (environment variables marked as secrets) are stored in your macOS Keychain with encryption, not in `board.json`. See [Terminal Context](../tutorials/terminal-context.md).
