...
Global environment variables injected into every terminal session. Manage variables and secrets here. See [Terminal Context](../tutorials/terminal-context.md) for details.
